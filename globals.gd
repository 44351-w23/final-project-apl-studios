...
const DEBUG_DISPLAY_SCENE = preload("res://General/Debug_Display.tscn")
var debug_display = null

const MAIN_MENU_PATH = "res://General/Main_Menu.tscn"
const POPUP_SCENE = preload("res://General/Pause_Popup.tscn")
var popup = null
...
const SIMPLE_AUDIO_PLAYER_SCENE = preload("res://General/Simple_Audio_Player.tscn")
var created_audio = []
