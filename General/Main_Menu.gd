...
func _ready():
	...
	$Options_Menu/Check_Button_Debug.connect("pressed",self,"options_menu_button_pressed",["vsync"])
	$Options_Menu/Check_Button_VSync.connect("pressed",self,"options_menu_button_pressed",["debug"])
...
func level_select_menu_button_pressed(button_name):
	...
	elif button_name == "space_scene":
		set_mouse_and_joypad_sensitivity()
		get_node("/root/Globals").load_new_scene(space_level_scene)
	elif button_name == "ruins_scene":
		set_mouse_and_joypad_sensitivity()
